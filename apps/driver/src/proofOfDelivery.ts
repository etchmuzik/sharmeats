 ...
 * refuses a delivery for missing proof (see mig 168). The button in the UI waits
 ...
 *
 * MUST stay in step with `public.delivery_proof_required(text)` in mig 168 —
 ...
 * mig 168 breaks uploads outright.
 */
