 ...
 * refuses a delivery for missing proof (see mig 180). The button in the UI waits
 ...
 *
 * MUST stay in step with `public.delivery_proof_required(text)` in mig 180 —
 ...
 * mig 180 breaks uploads outright.
 */
