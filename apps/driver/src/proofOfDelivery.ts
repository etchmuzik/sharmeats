 ...
 * refuses a delivery for missing proof (see mig 193). The button in the UI waits
 ...
 *
 * MUST stay in step with `public.delivery_proof_required(text)` in mig 193 —
 ...
 * mig 193 breaks uploads outright.
 */
