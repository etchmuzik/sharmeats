 ...
 * refuses a delivery for missing proof (see mig 194). The button in the UI waits
 ...
 *
 * MUST stay in step with `public.delivery_proof_required(text)` in mig 194 —
 ...
 * mig 194 breaks uploads outright.
 */
