...
/**
 * Reset-password landing for the recovery email link (merchant dashboard).
 *
 ...
 *
 * Ported from the admin-web reset flow so a locked-out restaurant owner can
 * self-recover instead of contacting the platform.
 */
