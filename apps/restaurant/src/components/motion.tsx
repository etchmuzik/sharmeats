 ...
 *
 * Durations are deliberately short (160–260ms). This is a working tool on a
 * counter tablet during a rush: motion here exists to explain *what changed*
 * (a ticket arrived, a ticket cleared), never to decorate. Anything slower than
 * ~260ms starts to feel like latency rather than feedback.
 */
