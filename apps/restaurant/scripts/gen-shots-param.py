...
import os as _os
OUT_W, OUT_H = int(_os.environ.get("SHOT_W", 1611)), int(_os.environ.get("SHOT_H", 2864))
HERE = os.path.dirname(os.path.abspath(__file__))
OUT_DIR = os.path.join(HERE, "..", "store-screenshots", os.environ.get("SHOT_DIR", "play-phone"))
